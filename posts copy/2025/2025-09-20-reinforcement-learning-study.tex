...
% <TAGs>: 2025, reinforcement learning, RL, policy gradient, Q-learning, AI
...
\begin{document}
\href{run:2025-09-20-reinforcement-learning-study.tex}{\Huge September 20} %##@@TitleDateString@@##
